     ...
     * Code Version 4.0 --- 15th Universities Education Exhibition & Disclosure - (CUEA) on 27th & 3rd March 2017 
     *                      : Presented to Cabinet Secretary of Education Dr. Fred Matiang'i
     *                      : BEST Project Featured in KTN Live with Ashley Mazuri and KTN Prime Business Bulleting by Doreen Biira on 28/2/2017
     * Code Version 5.0 --- ASK ELDORET SHOW - on 7th & 11th March 2017 
     * Code Version 5.0 : Presented in ASK Eldoret Show Ground 
     * 
    */
    ...
    int buttonState1 = 0; // Initial Button State is LOW
    int buttonState2 = 0; // Initial Button State is LOW
    ...
    //Weight Sensor Pin
    int weightPin = A0; //this takes in the analog value of the weight : From the Improvised Potentiometer
